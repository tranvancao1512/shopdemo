...
class Mobile_Detect
{
     ...
     * @return bool
     */
    public $cacheIsMobile = false;
    public $cacheIsPhone = false;

    public function isMobile($userAgent = null, $httpHeaders = null)
    {   
        if( $this->cacheIsMobile !== false ) return $this->cacheIsMobile;
        ...
        if ($this->checkHttpHeadersForMobile()) {
            $this->cacheIsMobile = true;
            return true;
        } else {
            $this->cacheIsMobile = 'false';
...
class Agent extends Mobile_Detect
{
    ...
    {   
        if( $this->cacheIsPhone !== false ) return $this->cacheIsPhone;
        if( $this->isMobile($userAgent, $httpHeaders) && !$this->isTablet($userAgent, $httpHeaders) ) {
            $this->cacheIsPhone = true;
        } else {
            $this->cacheIsPhone = 'false';
        }
        return $this->cacheIsPhone;
    }
