    ...
    class True_News_Tab_Posts_Widget extends True_News_Widget_Base {
        ...
        function __construct() {
            ...
            $fields = array(
                ...
                'popular_title' => array(
                    'label' => esc_html__('Popular Title:', 'true-news'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Popular', 'true-news'),
                ),
                ...
                'recent_title' => array(
                    'label' => esc_html__('Recent Title:', 'true-news'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Recent', 'true-news'),
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'true-news'),
                    'type'         => 'number',
                ...
                'comment_title' => array(
                    'label' => esc_html__('Comments Title:', 'true-news'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Comments', 'true-news'),
                ),
            ...
            parent::__construct( 'true-news-tabbed', esc_html__( 'TN: Tab Posts Widget', 'true-news' ), $opts, array(), $fields );
        ...
        function render_news($type, $params) {
            ...
            if( $type == 'popular' ){
                ...
                $tab_posts_query = new WP_Query( array(
