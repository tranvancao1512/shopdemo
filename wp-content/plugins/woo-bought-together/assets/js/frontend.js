...
jQuery(document).on('woosg_calc_price', function(e, total, total_html) {
  // change price for grouped product
  if (jQuery('.woobt_products[data-product-type="woosg"]').length) {
    jQuery('.woobt_products[data-product-type="woosg"]').
...
jQuery(document).
    on('wooco_calc_price', function(e, total, total_formatted, total_html) {
      ...
      if (jQuery('.woobt_products[data-product-type="composite"]').length) {
        jQuery('.woobt_products[data-product-type="composite"]').
            find('.woobt-product-this').
            attr('data-price', total).
            attr('data-regular-price', total);
        jQuery('.woobt_products[data-product-type="composite"]').
