...
class FW_Option_Type_Header_Builder_Item_Menu extends FW_Option_Type_Header_Builder_Item {
	private $parent = null;
	...
	public function _init() {
		...
		$this->set_options( array(
			...
			'menu-toggler'     => array(
				'type'    => 'select',
				'label'   => __( 'Menu toggler', 'lunar-core' ),
				'choices' => array(
					'simple' => __( 'Simple', 'lunar-core' ),
					'apple'  => __( 'Apple.com', 'lunar-core' ),
				),
				'value'   => 'simple',
			),
			'font_size'        => array(
				'type'  => 'text',
				'label' => __( 'Icon Font Size', 'lunar-core' ),
				'value' => '18',
				'attr'  => array(
					'type' => 'number',
				),
				...
				'choices'      => array(
					'custom' => array(
						'menu_background'          => array(
							'type'  => 'color-picker',
							'label' => __( 'Menu Background', 'lunar-core' ),
						),
						...
						'menu_item_typo'           => array(
							...
							'label'      => __( 'Menu Item Typography', 'lunar-core' ),
						),
						'menu_item_font_weight'    => array(
							'label'   => __( 'Menu Item Font Weight', 'lunar-core' ),
							'type'    => 'select',
							'value'   => '400',
						...
						'menu_item_color'          => array(
							'type'  => 'color-picker',
							'label' => __( 'Menu Item Color', 'lunar-core' ),
							'value' => basr_core_get_setting( 'color-heading' ),
						),
						'menu_item_color_hover'    => array(
							'type'  => 'color-picker',
							'label' => __( 'Menu Item Color Hover', 'lunar-core' ),
							'value' => basr_core_get_setting( 'color-main' ),
						),
						'menu_subitem_typo'        => array(
							'type'       => 'typography-v2',
							'value'      => array(
								'size'           => 14,
								'letter-spacing' => 0,
							...
							'label'      => __( 'Menu Sub Item Typography', 'lunar-core' ),
						),
						'menu_subitem_font_weight' => array(
							'label'   => __( 'Menu Sub Item Font Weight', 'lunar-core' ),
							'type'    => 'select',
							'value'   => '400',
							'choices' => array( '100', '200', '300', '400', '500', '600', '700', '800', '900' ),
						),
						'menu_subitem_color'       => array(
							'type'  => 'color-picker',
							'label' => __( 'Menu Sub Item Color', 'lunar-core' ),
							'value' => basr_core_get_setting( 'color-heading' ),
						),
						'menu_subitem_color_hover' => array(
							'type'  => 'color-picker',
							'label' => __( 'Menu Sub Item Color Hover', 'lunar-core' ),
							'value' => basr_core_get_setting( 'color-main' ),
						),
					),
				),
	...
	public function get_thumbnails() {
		...
		return array(
			array(
				'title'       => __( 'Menu', 'lunar-core' ),
				'description' => __( 'Add menu', 'lunar-core' ),
				'tab'         => __( 'Content Elements', 'lunar-core' ),
				'html'        =>
					'<div class="item-type-icon-title">' .
					'    <div class="item-type-icon"><i class="ion-android-menu"></i></div>' .
					'    <div class="item-type-title">' . __( 'Menu', 'lunar-core' ) . '</div>' .
					'</div>',
			),
		);
	}
	...
	public function enqueue_static() {
		...
		wp_localize_script(
			'header-builder-' . $this->get_builder_type() . '-item-' . $this->get_type(),
			'header_builder_item_type_menu',
			array(
				'l10n'     => array(
					'label'      => __( 'Label', 'lunar-core' ),
					'item_title' => __( 'Menu Setting', 'lunar-core' ),
					'name'       => __( 'Menu', 'lunar-core' ),
	...
	public function render( array $item, $input_value ) {
		...
		return fw_render_view(
			...
			array(
				...
				'toggler' => $item['options']['menu-toggler'],
				'class'   => $class,
				'type'    => $this->get_type(),
			)
		);
...
FW_Option_Type_Builder::register_item_type( 'FW_Option_Type_Header_Builder_Item_Menu' );
