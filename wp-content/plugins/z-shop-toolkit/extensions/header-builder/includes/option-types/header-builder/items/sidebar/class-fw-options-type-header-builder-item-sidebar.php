...
class FW_Option_Type_Header_Builder_Item_Sidebar extends FW_Option_Type_Header_Builder_Item {
	private $parent = null;
	...
	public function enqueue_static() {
		...
		wp_localize_script(
			'header-builder-' . $this->get_builder_type() . '-item-' . $this->get_type(),
			'header_builder_item_type_sidebar',
			array(
				'l10n'     => array(
					'label'      => __( 'Label', 'lunar-core' ),
					'item_title' => __( 'Sidebar Setting', 'lunar-core' ),
					'name'       => __( 'Sidebar', 'lunar-core' ),
...
FW_Option_Type_Builder::register_item_type( 'FW_Option_Type_Header_Builder_Item_Sidebar' );