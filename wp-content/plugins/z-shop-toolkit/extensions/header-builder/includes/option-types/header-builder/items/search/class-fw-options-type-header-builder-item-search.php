...
class FW_Option_Type_Header_Builder_Item_Search extends FW_Option_Type_Header_Builder_Item {
	private $parent = null;
	...
	public function get_thumbnails() {
		...
		return array(
			array(
				'title'       => __( 'Search', 'lunar-core' ),
				'description' => __( 'Search icon', 'lunar-core' ),
				'tab'         => __( 'Content Elements', 'lunar-core' ),
				'html'        =>
					'<div class="item-type-icon-title">' .
					'    <div class="item-type-icon"><i class="ion-android-search"></i></div>' .
					'    <div class="item-type-title">' . __( 'Search', 'lunar-core' ) . '</div>' .
					'</div>',
			),
		);
	}
	...
	public function enqueue_static() {
		...
		wp_localize_script(
			'header-builder-' . $this->get_builder_type() . '-item-' . $this->get_type(),
			'header_builder_item_type_search',
			array(
				'l10n'     => array(
					'label'      => __( 'Label', 'lunar-core' ),
					'item_title' => __( 'Search Setting', 'lunar-core' ),
					'name'       => __( 'Search', 'lunar-core' ),
...
FW_Option_Type_Builder::register_item_type( 'FW_Option_Type_Header_Builder_Item_Search' );