...
class FW_Option_Type_Header_Builder_Item_Flex_Space extends FW_Option_Type_Header_Builder_Item {
	private $parent = null;
	...
	public function get_thumbnails() {
		...
		return array(
			array(
				'title'       => __( 'Flex Space', 'lunar-core' ),
				'description' => __( 'Add header flex-space', 'lunar-core' ),
				'tab'         => __( 'Content Elements', 'lunar-core' ),
				'html'        =>
					'<div class="item-type-icon-title">' .
					'    <div class="item-type-icon">&harr;</div>' .
					'    <div class="item-type-title">' . __( 'Flex Space', 'lunar-core' ) . '</div>' .
					'</div>',
			),
		);
	}
	...
	public function enqueue_static() {
		...
		wp_localize_script(
			'header-builder-' . $this->get_builder_type() . '-item-' . $this->get_type(),
			'header_builder_item_type_flex_space',
			array(
				'l10n'     => array(
					'label'      => __( 'Label', 'lunar-core' ),
					'item_title' => __( 'Flex_Space Setting', 'lunar-core' ),
					'name'       => __( 'Flex_Space', 'lunar-core' ),
...
FW_Option_Type_Builder::register_item_type( 'FW_Option_Type_Header_Builder_Item_Flex_Space' );