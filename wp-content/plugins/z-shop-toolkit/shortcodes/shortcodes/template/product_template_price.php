...
class toolkit_basr_shortcode_product_template_price extends toolkit_basr_shortcode {

	// shortcode name 

	public $shortcode = 'product_template_price';
	...
	public function vc_map_shortcode() {
		...
		vc_map( array(
						'base' 				=> $this->base,
						'name' 				=> esc_html__( 'Product Price', 'basr-core' ),
						'class' 			=> '',
