...
class toolkit_basr_shortcode_product_template_variant_item_2 extends toolkit_basr_shortcode {

	// shortcode name 

	public $shortcode = 'product_template_variant_item_2';
	...
	public function vc_map_shortcode() {
		...
		vc_map( array(
						'base' 				=> $this->base,
						'name' 				=> esc_html__( 'Product Variant Item For Combine Product', 'basr-core' ),
						'class' 			=> '',
						...
						'params' 			=> array(
							...
							array(
								...
								'heading'     		=> esc_html__( 'Title type', 'basr-core' ),
								'type'        		=> 'textfield',
								'holder'     		=> 'div',
								'value'       		=> '',
								'description'		=> esc_html__( 'Type Title', 'basr-core' ),
								'admin_label' 		=> true,
							),

							array(
								'param_name'  		=> 'type_sku',
								'heading'     		=> esc_html__( 'Type Sku', 'basr-core' ),
								'type'        		=> 'textfield',
								'holder'     		=> 'div',
								'value'       		=> '',
								'admin_label' 		=> true,
							...
							array(
								'param_name'  		=> 'title',
								'heading'     		=> esc_html__( 'Title Option', 'basr-core' ),
								'type'        		=> 'textfield',
								'holder'     		=> 'div',
								'value'       		=> '',
								'description'		=> esc_html__( 'Option Title', 'basr-core' ),
								'admin_label' 		=> true,
							),
